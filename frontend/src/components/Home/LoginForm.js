          ...
          <MDBCol md="6">
            <MDBCardBody className="d-flex flex-column">
              ...
              <p className="mb-5 pb-lg-2" style={{ color: "#393f81" }}>
                ...
                <a href="/PatientRegisteration" style={{ color: "#393f81" }}>
                  {" "}
                  <u> Register as a patient </u>
                </a>
                <a>|</a>{" "}
                <a href="/DoctorRegisteration" style={{ color: "#393f81" }}>
                  {" "}
                  <u> Register as a doctor </u>
                </a>
              </p>
